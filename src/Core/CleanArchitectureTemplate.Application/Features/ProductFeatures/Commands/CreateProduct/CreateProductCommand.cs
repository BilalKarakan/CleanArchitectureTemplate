...
public record CreateProductCommand(string Name, string Description, int Quantity, decimal Price, string CategoryId, Category Category) : IRequest<CommonResponse>;
